...
impl GradDesc
{
    ...
    pub fn new( dim: usize ) -> Self {
        let x_new: Arr<f64> = Arr::new(dim);
        let grad: Arr<f64> = Arr::new(dim);
...
impl AdamW
{
    ...
    pub fn new( dim: usize ) -> Self {
        let grad: Arr<f64> = Arr::new(dim);
        let grad2: Arr<f64> = Arr::new(dim);
        let m1: Arr<f64> = Arr::new(dim);
        let m2: Arr<f64> = Arr::new(dim);
        let m1_hat: Arr<f64> = Arr::new(dim);
        let m2_hat: Arr<f64> = Arr::new(dim);
...
pub struct SR1 { // https://zhuanlan.zhihu.com/p/306635632
    ...
    pub grad0: Arr<f64>,
    pub grad1: Arr<f64>,
    pub delta_grad: Arr<f64>,
    pub hess_inv: Mat<f64>,
}
...
impl SR1
{
    ...
    pub fn new( dim: usize ) -> Self {
        ...
        let x_new: Arr<f64> = Arr::new(dim);
        let dir: Arr<f64> = Arr::new(dim);
        let grad0: Arr<f64> = Arr::new(dim);
        let grad1: Arr<f64> = Arr::new(dim);
        let delta_grad: Arr<f64> = Arr::new(dim);
        let mut hess_inv: Mat<f64> = Mat::new(dim, dim);
...
impl DampedNewton
{
    ...
    pub fn new( dim: usize ) -> Self {
        ...
        let grad: Arr<f64> = Arr::new(dim);
        let dir: Arr<f64> = Arr::new(dim);
        let hess: Mat<f64> = Mat::new(dim, dim);
...
pub struct BFGS {
    ...
    pub grad1: Arr<f64>,
    pub delta_grad: Arr<f64>,
    pub hess_inv0: Mat<f64>,
    pub hess_inv1: Mat<f64>,
    pub mbuf0: Mat<f64>,
    pub mbuf1: Mat<f64>,
    pub mbuf2: Mat<f64>,
}
...
impl BFGS
{
    ...
    pub fn new( dim: usize ) -> Self {
        let hess_inv_scalar: f64 = 0.01;
        let x_new: Arr<f64> = Arr::new(dim);
        let delta_x: Arr<f64> = Arr::new(dim);
        let dir: Arr<f64> = Arr::new(dim);
        let grad0: Arr<f64> = Arr::new(dim);
        let grad1: Arr<f64> = Arr::new(dim);
        let delta_grad: Arr<f64> = Arr::new(dim);
        let mut hess_inv0: Mat<f64> = Mat::new(dim, dim);
        hess_inv0.set_diag(hess_inv_scalar);
        let mut hess_inv1: Mat<f64> = Mat::new(dim, dim);
        hess_inv1.set_diag(hess_inv_scalar);
        let mbuf0: Mat<f64> = Mat::new(dim, dim);
        let mbuf1: Mat<f64> = Mat::new(dim, dim);
        let mbuf2: Mat<f64> = Mat::new(dim, dim);
