...
pub fn dgemmt_( uplo: *const BlasChar, transa: *const BlasChar, transb: *const BlasChar, n: *const BlasUint, k: *const BlasUint, alpha: *const f64, a: *const f64, lda: *const BlasUint, b: *const f64, ldb: *const BlasUint, beta: *const f64, c: *mut f64, ldc: *const BlasUint );
...
#[inline]
pub fn dgemmt<MT1: RMat<f64>, MT2: RMat<f64>, MT3: RMatMut<f64>>( 
    alpha: f64,   
    a: &MT1,
    b: &MT2,
    beta: f64, 
